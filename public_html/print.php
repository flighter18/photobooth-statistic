...
#echo  $_SESSION['sessionEventName'];

# GO HOME IF SESSION EXPIRED
...
########################
$sqlPrinted = "SELECT p.printDate, p.printTime, p.printName, e.eventName, p.printID FROM print AS p INNER JOIN event AS e on p.eventID=e.eventID WHERE e.eventID = $eventID ORDER BY p.printID DESC";
  ...
  <div class="d-flex flex-column flex-md-row align-items-center p-3 mb-3 box-shadow border-bottom">
   <a class="my-0 mr-md-auto font-weight-normal" href="home.php">Photobooth Stats</a>    
    <nav class="my-2 my-md-0 mr-md-3">
      ...
      <a class="p-2" href="print.php"><b><b>PRINT</b></b></a>
      <a class="p-2" href="new.php">NEW</a>
      ...
      <div class="row">
       <div class="col-md-12">
		  ...
		  <th class="table-light" style="">Time</th>
                ...
                <?php
                while($rowPrint = mysqli_fetch_array($result)) { ?>
              <tbody>
                <tr>
                  <td><?php echo $rowPrint['printDate'];?></td>
                  <td><?php echo $rowPrint['printTime'];?></td>
                  <td><?php echo $rowPrint['printName'];?></td>
                </tr>
              </tbody>
                <?php } ?>
            </table>
